...
public abstract class AbstractTree<E> implements Tree<E> {
    ...
    public E set(Position<E> p, E value) {
        AbstractTreeNode<E> pNode = validate(p);
        E temp = pNode.getElement();
        pNode.setElement(value);
        return temp;
    }   
     ...
     * @param p position
     * @param traversal traversal position collection
     */
    ...
    /**
     * Defines the abstract tree node
     * @author Dr. King
     *
