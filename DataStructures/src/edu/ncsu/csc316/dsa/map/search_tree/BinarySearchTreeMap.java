...
public class BinarySearchTreeMap<K extends Comparable<K>, V> extends AbstractOrderedMap<K, V> {
    ...
    protected static class BalanceableBinaryTree<K, V> extends LinkedBinaryTree<Entry<K, V>> {
        ...
        public void rotate(Position<Entry<K, V>> p) {
            ...
            // relink the parent adn the node and transfer node's subtree
            if (node == left(parent)) {
        ...
        public Position<Entry<K, V>> restructure(Position<Entry<K, V>> x) {
            ...
            if ( (node == left(parent) && parent == left(grandparent)) || (node == right(parent) && parent == right(grandparent))) {
    ...
    /**
     * Checks if position is internal
     * @param p position
    ...
    /**
     * Sets entry of position
     * @param p postion
     * @param entry entry
     * @return old entry before being set
     */
