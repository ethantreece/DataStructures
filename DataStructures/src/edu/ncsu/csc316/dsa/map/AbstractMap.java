...
public abstract class AbstractMap<K, V> implements Map<K, V> {
    ...
    protected class EntryCollection implements Iterable<Entry<K, V>> {
        ...
        /**
         * Constructs the EntryCollection
         */
        ...
        /**
         * Adds a given entry to the end of the list of entries
         * @param entry entry
         */
        ...
        /**
         * Gets the iterator for EntryCollection
         * @return iterator for EntryCollection
         */
        ...
        /**
         * EntryCollectionIterator defines an iterator to be used for EntryCollection
         * 
         * @author Dr. King
         *
         */
        private class EntryCollectionIterator implements Iterator<Entry<K, V>> {
            ...
            /**
             * Constructs the EntryCollectionIterator
             */
    ...
    /**
     * Value Iterable wraps the ValueIterator into and Iterable object
     * 
     * @author Dr. King
     *
     */
