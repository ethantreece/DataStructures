...
public class AdjacencyListGraphTest {
    ...
    /**
     * Builds a directed graph sample
     */
    ...
    public void testInsertEdge() {
        ...
        Vertex<String> v3 = undirectedGraph.insertVertex("Washington");
        
        assertEquals(1, undirectedGraph.numEdges());
        Edge<Integer> e2 = undirectedGraph.insertEdge(v2, v3, 100);
        ...
        assertEquals(100, (int) e2.getElement());
